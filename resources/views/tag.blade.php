...
<html ⚡ lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>CodersParaphernalia - {{$tag}}</title>

        <meta name="description" content="The best products tagged with {{$tag}}">
        <meta name="language" content="en">
        <meta name="robots" content="index,follow">
        <meta http-equiv="content-language" content="en">
        <link rel="canonical" href="{{url('/')}}">
        <meta property="og:title" content="CodersParaphernalia - {{$tag}}">
        <meta property="og:url" content="{{url('/')}}">
        <meta property="og:description" content="The best products tagged with {{$tag}}">
        ...
        <meta name="twitter:title" content="CodersParaphernalia - {{$tag}}">
        <meta name="twitter:description" content="The best products tagged with {{$tag}}">
